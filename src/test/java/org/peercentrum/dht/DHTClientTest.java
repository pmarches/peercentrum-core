...
//    TransientMockNetworkOfNodes mockNetwork=new TransientMockNetworkOfNodes();
    ...
    DHTApplication dht0=(DHTApplication) mockNetwork.server[0].getApplicationHandler(DHTApplication.APP_ID);
...
//    assertEquals(dht0.dhtClient.buckets.size(), mockNetwork.server[0].getNodeDatabase().size());
    ...
    DefaultPromise<DHTSearch> searchNode0 = client0.searchNetworkForNode(server1);
    ...
    DefaultPromise<DHTSearch> searchNode5 = client0.searchNetworkForNode(server5);
    ...
    DefaultPromise<DHTSearch> searchStoredKey1 = client0.searchNetworkForNode(storedKey1);
